		...
		<div class="collapse navbar-collapse" id="navbarsFurni">
			...
			<ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
				<li><a class="nav-link" href="?pg=login-member">
						<img src="asset/fe/images/user.svg"><?php echo isset($data['nama_lengkap']) ? $data['nama_lengkap'] : '' ?>
					</a>
				</li>
				<li><a class="nav-link" href="?pg=cart"><img src="asset/fe/images/cart.svg"><?php echo isset($cart_count) ? $cart_count : '' ?></a></li>
			</ul>
		</div>
	</div>
