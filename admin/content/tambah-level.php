...
<form action="" method="post">
    <div class="mb-3">
        ...
        <input value="<?php echo isset($_GET['edit']) ? $rowEdit['nama_level'] : '' ?>" type="text" class="form-control" name="nama_level" placeholder="masukan nama level">
    </div>

    <div class="mb-3">
        <label for="">Keterangan</label>

        <textarea class="form-control" id="" name="keterangan" placeholder="Masukan Keterangan">
